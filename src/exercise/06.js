...
function DogProvider(props) {
  ...
  return <DogContext.Provider value={[state, dispatch]} {...props} />
}
...
function withSliceState(Comp, slice) {
...
Cell = withSliceState(Cell, (state, {row, column}) => state.grid[row][column])
